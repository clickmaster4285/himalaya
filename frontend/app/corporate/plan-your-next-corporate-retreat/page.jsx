...
import {
    ...
    Gift, Target, PenTool, Smile, ThermometerSun
} from "lucide-react";

const heroSlides = [
    "/assets/retreat1.webp",
    "/assets/retreat2.webp",
    "/assets/retreat3.webp",
];

const retreatSpaces = [
    {
        title: "Strategic Planning Hall",
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="relative min-h-[720px] overflow-hidden">
                ...
                {/* Dark overlay - balanced for text visibility while keeping image visible */}
                <div className="absolute inset-0 bg-black/50" aria-hidden="true" />

                {/* Additional gradient overlay for bottom text area */}
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 pt-36 pb-20 md:pt-44">
                    <div className="inline-flex items-center gap-2 rounded-full bg-black/40 backdrop-blur-sm px-4 py-1.5 mb-5 border border-white/20">
                        <Building2 className="h-3.5 w-3.5 text-[#c9a55b]" />
                        <span className="text-[10px] sm:text-xs uppercase tracking-wider text-white font-semibold">Corporate Retreats & Offsites</span>
                    </div>

                    <h1 className="font-display text-4xl md:text-6xl text-white leading-tight max-w-3xl drop-shadow-lg">
                        Plan Your Next
                        <br />
                        Corporate Retreat
                    </h1>

                    <p className="mt-5 max-w-2xl text-white/95 text-sm md:text-base leading-relaxed drop-shadow-md">Host your plan your next corporate retreat with us. Strategize, bond, and recharge with our all-inclusive corporate retreat packages. We provide the ideal environment for productive offsites and team building.</p>

                    <div className="mt-8 flex flex-col sm:flex-row gap-4">
                        <a href="#book" className="inline-block rounded-md bg-[#c9a55b] px-6 py-3 text-xs font-semibold uppercase tracking-wider text-white hover:bg-[#a98741] transition text-center shadow-lg">
                            Inquire Now
                        </a>
                        <a href="#packages" className="inline-block rounded-md border border-white/30 bg-black/30 backdrop-blur-sm px-6 py-3 text-xs font-semibold uppercase tracking-wider text-white hover:bg-white/20 transition text-center shadow-lg">
            ...
            <section className="py-16 md:py-20 bg-[#fbf7ee]">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="mb-10 text-center">
                        ...
                        <h2 className="font-display text-3xl md:text-4xl text-neutral-900 mt-2">Retreat & Workshop Spaces</h2>
                        <p className="mt-3 text-sm md:text-base text-neutral-600 max-w-2xl mx-auto">
                            Choose the perfect setting for strategy sessions, workshops, and team activities
                        </p>
                    </div>
                    <div className="grid gap-6 md:grid-cols-3">
                        {retreatSpaces.map((space) => {
            ...
            {/* Retreat Amenities Section */}
            <section className="py-16 md:py-20 bg-white">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="text-center mb-10">
                        <h2 className="font-display text-3xl md:text-4xl text-neutral-900">Included Amenities</h2>
                        <p className="mt-3 text-sm md:text-base text-neutral-600">Everything you need for a seamless retreat experience</p>
                    </div>
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                        {retreatAmenities.map((amenity) => {
            ...
            <section id="packages" className="py-16 md:py-20 bg-[#0f172a] text-white">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-3 text-sm md:text-base text-white/80">Customizable corporate offsite experiences</p>
                    </div>
                    <div className="grid gap-6 md:grid-cols-3">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-start">
                        ...
                        <div>
                            <div className="inline-flex items-center gap-2 rounded-full bg-[#c9a55b]/10 px-4 py-1.5 mb-4">
                                ...
                                <span className="text-[10px] uppercase tracking-wider text-[#c9a55b] font-semibold">Why Choose Our Retreats</span>
                            </div>
                            <h2 className="font-display text-3xl md:text-4xl text-neutral-900">Purpose-Driven Corporate Retreats</h2>
                            <p className="mt-3 text-sm md:text-base text-neutral-600">Designed to foster connection, creativity, and results</p>
                            <ul className="mt-6 space-y-3">
                                {retreatBenefits.map((item) => (
                        ...
                        <div className="bg-[#fbf7ee] rounded-2xl p-6 border border-[#e8dfcf]">
                            <div className="inline-flex items-center gap-2 rounded-full bg-[#c9a55b]/10 px-4 py-1.5 mb-4">
                                <Calendar className="h-3.5 w-3.5 text-[#c9a55b]" />
                                <span className="text-[10px] uppercase tracking-wider text-[#c9a55b] font-semibold">Sample Itinerary</span>
                            </div>
                            <h3 className="text-2xl font-semibold text-neutral-900 mb-4">2-Day Retreat Schedule</h3>
                            {venueSchedule.map((item) => (
                                <div key={item.time} className="mb-4 last:mb-0 flex gap-3">
                                    <div className="w-20 flex-shrink-0">
                                        <p className="font-semibold text-[#c9a55b] text-sm">{item.time}</p>
                                    </div>
                                    <div>
                            ...
                            <p className="mt-4 text-xs text-neutral-500 italic">*Fully customizable based on your goals and timeline</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 md:py-20 bg-[#0f172a] text-white">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="text-center mb-10">
                        <h2 className="font-display text-3xl md:text-4xl text-white">Retreat Gallery</h2>
                        <p className="mt-3 text-sm md:text-base text-white/80">Explore our inspiring spaces</p>
                    </div>
            ...
            <section className="py-16 md:py-20 bg-[#fbf7ee]">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-3 text-sm md:text-base text-neutral-600">Feedback from companies who've retreated with us</p>
                    </div>
                    <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-3 text-sm md:text-base text-gray-600">
                            Everything you need to know about planning a corporate retreat with us
                        </p>
                    </div>
            ...
            <section id="book" className="py-12 sm:py-16 md:py-20 bg-neutral-900 text-white">
                <div className="mx-auto max-w-5xl px-4 sm:px-6">
                    <div className="rounded-xl sm:rounded-2xl border border-white/20 bg-white/5 p-4 sm:p-6 md:p-8 lg:p-10">
                        <h2 className="font-display text-2xl sm:text-3xl md:text-4xl text-center sm:text-left">Plan Your Retreat</h2>
                        ...
                        <form className="mt-5 sm:mt-6 md:mt-8 grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2">
                            ...
                            <select className="col-span-1 rounded-lg border border-white/30 bg-white/10 px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm outline-none focus:border-[#c9a55b] transition focus:bg-white/15">
                                <option value="" className="bg-neutral-900">Select Retreat Type</option>
                                <option className="bg-neutral-900">Strategic Planning / Board Retreat</option>
                                <option className="bg-neutral-900">Team Building & Culture</option>
                                <option className="bg-neutral-900">Innovation & Design Sprint</option>
                                <option className="bg-neutral-900">Leadership Development</option>
                                <option className="bg-neutral-900">Departmental Offsite</option>
                            </select>
                            <input
                                type="date"
                            ...
                            />
                            <select className="col-span-1 rounded-lg border border-white/30 bg-white/10 px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm outline-none focus:border-[#c9a55b] transition focus:bg-white/15">
                                <option value="" className="bg-neutral-900">Number of Attendees</option>
                                <option className="bg-neutral-900">10-25 (Small Group)</option>
                                <option className="bg-neutral-900">25-50</option>
                                <option className="bg-neutral-900">50-100</option>
                                <option className="bg-neutral-900">100-200</option>
                                <option className="bg-neutral-900">200-500</option>
                            </select>
                            <select className="col-span-1 rounded-lg border border-white/30 bg-white/10 px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm outline-none focus:border-[#c9a55b] transition focus:bg-white/15">
                                <option value="" className="bg-neutral-900">Preferred Duration</option>
                                <option className="bg-neutral-900">One Day Offsite (8 hours)</option>
                                <option className="bg-neutral-900">Weekend Retreat (2 days / 1 night)</option>
                                <option className="bg-neutral-900">Executive Summit (3 days / 2 nights)</option>
                                <option className="bg-neutral-900">Custom Duration</option>
                            </select>
                            <textarea
                                rows={4}
                                ...
                                placeholder="Tell us about your retreat goals, preferred activities, dietary needs, and any special requests..."
                            />
                            <button
                                type="submit"
                        ...
                        <p className="mt-4 text-[10px] sm:text-xs text-white/50 text-center">
                            Our retreat specialists will respond within 24 hours
                        </p>
                    </div>
                </div>
            </section>
