        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative min-h-[720px] overflow-hidden">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 pt-36 pb-20 md:pt-44">
                    ...
                    <p className="mt-5 max-w-2xl text-white/95 text-sm md:text-base leading-relaxed drop-shadow-md">
                        Strategize, bond, and recharge with our all-inclusive corporate retreat packages.
                        We provide the ideal environment for productive offsites and team building.
                    </p>
