        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative min-h-[720px] overflow-hidden">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 pt-36 pb-20 md:pt-44">
                    ...
                    <p className="mt-5 max-w-2xl text-white/90 text-sm md:text-base leading-relaxed drop-shadow-sm">Host your dignified events honoring professional journeys with us. Celebrate a lifetime of achievement with elegance and respect. From intimate family dinners to grand organizational galas, we create retirement events that honor the legacy.</p>
