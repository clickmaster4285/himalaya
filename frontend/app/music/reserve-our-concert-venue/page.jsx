        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative min-h-[720px] overflow-hidden">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 pt-36 pb-20 md:pt-44">
                    ...
                    <p className="mt-5 max-w-2xl text-white/90 text-sm md:text-base leading-relaxed">Host your reserve our concert venue with us. Host your private concert, recital, or jazz evening in our acoustically-optimized venue. We provide the perfect space, professional sound, and elegant ambiance for unforgettable musical events.</p>
