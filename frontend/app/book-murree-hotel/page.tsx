...
export default function BookMurreeHotelPage() {
  ...
  const roomTypes = [
    {
      id: "rakaposhi-single-executive",
      name: "Single Executive Room",
      price: "16,500",
      originalPrice: "22,000",
      image: "/images/villas/rak-single-room.jpg",
      features: ["King Size Bed", "Mountain View", "Private Terrace", "Breakfast Included"],
      size: "280 sq ft",
      capacity: "2 Adults",
    ...
    },
    {
      ...
      features: ["Marble Accents", "Mountain Views", "Premium Linens", "Breakfast Included"],
      size: "380 sq ft",
      capacity: "2 Adults",
    ...
    },
    {
      ...
      features: ["Private Sitting Area", "Chandelier Lighting", "Mountain Views", "Breakfast Included"],
      size: "520 sq ft",
      capacity: "2–3 Adults",
    ...
    },
    {
      ...
      name: "Complete Luxury Villa",
      price: "99,000",
      originalPrice: "120,000",
      image: "/images/villas/lux-complete-villa.jpg",
      features: ["4 Bedrooms", "Private Garden", "Exclusive Use", "Breakfast Included"],
      size: "Full Villa",
