        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative min-h-[720px] overflow-hidden">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 pt-36 pb-20 md:pt-44">
                    ...
                    <p className="mt-5 max-w-2xl text-white/90 text-sm md:text-base leading-relaxed drop-shadow-sm">Host your make a statement with your launch with us. Unveil your product in style with our premium event venue. From intimate brand previews to large-scale productions, we deliver unforgettable launch experiences.</p>
