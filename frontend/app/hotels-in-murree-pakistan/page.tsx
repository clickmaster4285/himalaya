...
.murree-hotels-reveal{opacity:0;transform:translateY(40px) translateZ(0);transition:opacity .9s ease-out,transform .9s ease-out;}
.murree-hotels-reveal.in{opacity:1;transform:translateY(0) translateZ(0);}

@keyframes murree-hotelsKenBurns{0%{transform:scale(1) translateZ(0)}100%{transform:scale(1.15) translateZ(0)}}
  ...
  return (
    <div className="py-8 md:py-12 px-6">
      <div className="mx-auto w-full max-w-6xl">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl murree-hotels-shadow-lux" style={{ background: "hsl(165 60% 18%)", color: "hsl(40 38% 97%)" }}>
            ...
            <div className="relative z-10 flex flex-col items-center justify-between gap-6 p-6 md:flex-row md:p-10 lg:p-12">
              <div className="text-center md:text-left max-w-xl">
                ...
                <p className="text-base" style={{ color: "hsl(40 38% 97% / 0.85)" }}>
                  Speak directly with our concierge team to customize your private estate experience in Murree.
                </p>
              </div>
              
              <div className="flex shrink-0 flex-col gap-3 w-full sm:flex-row sm:w-auto">
                <a
                  href={MURREE_WHATSAPP_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 rounded-full murree-hotels-grad-gold px-6 py-3 font-bold text-base transition-transform hover:scale-105 murree-hotels-shadow-gold w-full sm:w-auto"
                  style={{ color: "hsl(165 60% 18%)" }}
                >
