...
export const faqData: FaqCategory[] = [
  {
    ...
    questions: [
      {
        q: "What is Himalaya Villas?",
        a: "Himalaya Villas is a luxury private villa resort located in Bhurban, Murree Hills, Pakistan. It offers exclusive villa rentals with panoramic mountain views, premium interiors, personalized service, and dedicated event hosting — designed for families, couples, corporate groups, and destination weddings.",
      },
      {
        q: "What are the best luxury villas in Murree?",
        a: "Himalaya Villas is widely regarded as one of the finest luxury villa experiences in Murree, offering private villa rentals with panoramic Himalayan views, premium furnishings, and fully personalized hospitality — setting it apart from conventional hotel accommodation.",
      },
      {
        q: "Is Himalaya Villas a hotel or a private villa rental?",
        a: "Himalaya Villas is a private luxury villa resort — not a standard hotel. Guests rent exclusive villa accommodation, ensuring complete privacy, dedicated service, and a bespoke experience not possible in a shared hotel environment.",
      },
      {
        q: "Where is Himalaya Villas located?",
        a: "Himalaya Villas is located in Bhurban, Murree Hills, Pakistan — approximately 60 km from Islamabad, only one hour and thirty minutes drive from Islamabad. The property sits at high altitude in the pine-forested hills of Bhurban forest, offering a cool mountain climate and spectacular natural surroundings.",
      },
      {
      ...
      {
        q: "Is Himalaya Villas suitable for both leisure and business guests?",
        a: "Yes. Himalaya Villas caters to a wide range of guests including leisure travellers, families, honeymooning couples, corporate teams, and event hosts. The property offers tailored experiences and packages for each guest profile.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "How can I book a villa at Himalaya Villas, Murree?",
      ...
      {
        q: "Are short stays available at Himalaya Villas?",
      ...
      {
        q: "What are the check-in and check-out times at Himalaya Villas?",
    ...
    questions: [
      {
        ...
        a: "Bhurban is approximately 55–65 km from central Islamabad, typically a 1.5 to 2-hour drive via the Murree Expressway. The route is well-maintained and accessible year-round, making Himalaya Villas an ideal weekend escape from the twin cities.",
      },
      {
        q: "How far is Himalaya Villas from Rawalpindi?",
        a: "Himalaya Villas is approximately 55 km from Rawalpindi — around 1.5 to 2 hours by road via the Murree Expressway. It is a straightforward and well-signposted route from Pindi.",
      },
      {
        q: "How far is Himalaya Villas from Lahore?",
      ...
      {
        q: "What is the nearest airport to Himalaya Villas?",
      ...
      {
        q: "Are there local attractions near Himalaya Villas in Bhurban?",
  ...
  },
  {
    ...
    questions: [
      {
        q: "What is included in the villa rental at Himalaya Villas?",
      ...
      },
      {
        ...
        a: "Yes. All villas at Himalaya Villas are fully furnished to a premium standard, featuring contemporary luxury interiors, quality furnishings, premium linens, and thoughtfully designed spaces that reflect the mountain setting.",
      },
      {
        q: "Is WiFi available at Himalaya Villas?",
      ...
      {
        q: "Is professional staff available on-site at Himalaya Villas?",
      ...
      {
        q: "How many villas are available at Himalaya Villas?",
        a: "Himalaya Villas maintains a deliberately limited number of private villas to preserve the exclusivity and intimacy of the experience. Please contact our team directly for current availability and capacity details.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "Is food and dining available at Himalaya Villas?",
      ...
      {
        q: "Is halal food available at Himalaya Villas?",
        a: "Yes, all food served at Himalaya Villas is halal, prepared and handled in accordance with Islamic dietary standards.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: "Is Himalaya Villas a wedding venue in Murree?",
        a: "Yes. Himalaya Villas is one of the most sought-after destination wedding venues in Murree and Bhurban. The property offers scenic outdoor ceremony spaces, mountain backdrops, luxury accommodation for the wedding party, and coordinated event services — all within an exclusively private setting.",
      },
      {
        q: "What types of events can be hosted at Himalaya Villas?",
        a: "Himalaya Villas hosts a range of private events including destination weddings, mehndi and wedding-related celebrations, milestone birthday gatherings, corporate retreats and team off-sites, executive board meetings, product launches, and private family celebrations.",
      },
      {
        q: "What is the guest capacity for events at Himalaya Villas?",
        a: "Himalaya Villas can accommodate events of varying sizes. For specific capacity figures for your event type and layout, please contact our events team directly. We work closely with clients to design events within the property's natural spaces.",
      },
      {
        q: "Are Himalaya Villas suitable for corporate retreats?",
        a: "Yes. Himalaya Villas is an ideal setting for executive retreats, leadership off-sites, strategy sessions, and team-building programmes. The property offers private meeting spaces, high-speed WiFi, catering, and full accommodation — away from urban distractions in a setting that inspires clear thinking and productive discussion.",
      },
      {
      ...
      {
        q: "Can we exclusively book Himalaya Villas for our event?",
      ...
      {
        q: "Is Himalaya Villas available for birthday parties and private celebrations?",
        a: "Yes. Himalaya Villas hosts private birthday celebrations, anniversary dinners, engagement parties, and family gatherings. Our team can assist with customized decoration, catering, and entertainment arrangements.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "Are Himalaya Villas suitable for families with children?",
        a: "Yes. Himalaya Villas is a family-friendly property with spacious villa layouts, safe outdoor areas, and a private environment ideal for families travelling with children. The mountain setting and natural surroundings also offer a refreshing and engaging environment for younger guests.",
      },
      {
        q: "Is Himalaya Villas suitable for couples and honeymoons?",
        a: "Yes. Himalaya Villas is a popular choice for honeymoons and couples' retreats. The combination of private villa accommodation, intimate mountain setting, and the ability to arrange romantic dining and personalized touches makes it an ideal destination for couples seeking privacy and luxury.",
      },
      {
        q: "Is Himalaya Villas suitable for large groups?",
      ...
      {
        q: "Is Himalaya Villas good for a weekend getaway from Islamabad?",
        a: "Absolutely. At approximately 1.5–2 hours from Islamabad, Himalaya Villas is one of the most accessible and rewarding weekend escapes from the capital. Guests frequently book Friday-to-Sunday stays to decompress in the mountains without a long journey.",
      },
      {
        q: "Is the environment peaceful and private?",
        a: "Yes. Unlike the main Murree strip which can be very crowded, particularly during peak summer and holiday periods, Bhurban offers a quieter and more refined environment. Himalaya Villas is specifically designed around privacy — guests are not sharing corridors, lobbies, or common areas with large numbers of strangers.",
      },
      {
        q: "Is Himalaya Villas safe and secure?",
  ...
  },
  {
    ...
    questions: [
      {
        q: "What is the best time to visit Himalaya Villas, Murree?",
        a: "Himalaya Villas is a year-round destination. The peak leisure season is May through August when temperatures are 15–25°C — a refreshing contrast to the lowland heat. The monsoon period (July–August) brings lush greenery and dramatic cloud landscapes. Winter (November–February) offers a crisp, serene atmosphere and occasional snowfall. Spring (March–April) is particularly beautiful with blossoming scenery.",
      },
      {
        q: "How is the weather in Bhurban during summer?",
        a: "Summer in Bhurban (June–August) is pleasantly cool, with daytime temperatures typically ranging from 18–26°C. This contrasts dramatically with temperatures exceeding 40°C in Islamabad, Lahore, and Karachi during the same period — making Himalaya Villas an extremely popular escape during these months.",
      },
      {
        q: "Does Himalaya Villas get snow in winter?",
      ...
      {
        q: "Is Himalaya Villas available during Eid holidays?",
        a: "Yes, Himalaya Villas operates during all Eid holidays (Eid ul Fitr and Eid ul Adha). These are among our busiest periods and villas typically book out weeks in advance. We strongly recommend early booking to secure your preferred Eid dates. Special Eid packages are available — contact our team for details.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "How much does it cost to stay at Himalaya Villas?",
        a: "Rates vary by villa type, season, and the number of guests. Himalaya Villas is positioned as a premium luxury property with pricing to match the exclusivity and quality of the experience. For current availability and pricing, please contact our reservations team directly or visit our official website.",
      },
      {
