...
export const UNIVERSAL_FAQS: UniversalFaq[] = [
  ...
  },
  {
    ...
    a: "June, July, and August are peak months for Murree and Bhurban because of lush scenery and mild weather. For quieter roads and more privacy, September and October are often preferred by premium travelers. Your best month depends on crowd preference and travel purpose. Check live availability: +92 304 567 9000.",
  },
  {
    q: "Which is the most beautiful place in Murree?",
    a: "Many travelers rank Bhurban among the most beautiful parts of the Murree Hills due to elevation, forest density, and wide valley views. It offers a calmer and more private environment than central crowded zones. For guests prioritizing scenery and comfort, Bhurban is often the strongest choice. Bookings: +92 304 567 9000.",
  },
  {
  ...
  },
  {
    ...
    a: "You can book directly via WhatsApp or through the website contact flow. Direct booking is recommended because it allows date coordination, dietary requests, and pre-arrival planning in one conversation. For fastest response, send your dates and guest count on WhatsApp: +92 304 567 9000.",
  },
  {
  ...
  },
  {
    ...
    a: "Couples usually prefer private mountain stays with view-facing suites, curated dining, and discreet support. For honeymoon planning, prioritize privacy, room positioning, and evening experience quality over generic package labels.",
  },
  {
    q: "What outdoor activities do Bhurban resorts provide?",
    a: "Popular options include guided nature walks, sunrise viewpoints, local excursions, and family-friendly adventure planning based on weather and season. Activity quality improves when transport and timing are coordinated in advance.",
  },
  {
    q: "Are there resorts in Bhurban with private balconies and mountain views?",
    a: "Yes, premium villa-style properties in Bhurban usually prioritize terrace and balcony orientation for uninterrupted mountain views. Always verify view type and room category before confirming your booking.",
  },
  {
    q: "Are there resorts in Bhurban with fitness facilities?",
    a: "Many premium stays offer indoor fitness support and outdoor alternatives like guided walks. In Bhurban, outdoor movement often provides a better wellness experience because of altitude, cleaner air, and scenic terrain.",
  },
  {
    q: "Which Bhurban resorts offer customized wedding or event planning?",
    a: "Premium venues in Bhurban offer curated planning for intimate weddings, private celebrations, and executive events. Look for teams that handle setup, hospitality, and day-of coordination in one managed flow.",
  },
  {
    q: "Are there Bhurban resorts with guided hiking or nature tours?",
    a: "Yes. Guided nature routes, sunrise walks, and local hill excursions are available in and around Bhurban. Confirm route difficulty, seasonal suitability, and transport support before finalizing plans.",
  },
  {
    q: "Which Bhurban resorts have accessible rooms and facilities?",
    a: "Accessibility support varies by property. Guests with mobility needs should contact the venue before booking to confirm ground-level access, room layout suitability, and practical movement support.",
  },
  {
    q: "How do I cancel or modify a Bhurban reservation?",
    a: "Change and cancellation terms depend on booking channel and travel window. Direct bookings usually allow faster assistance for date changes and guest-detail updates. Always verify policy before payment.",
  },
  {
    q: "How do I get early check-in or late check-out in Bhurban?",
    a: "Early check-in and late check-out are usually subject to same-day availability. Request these at least 24 to 48 hours before arrival for better approval chances.",
  },
  {
    q: "How do I check availability for group stays in Bhurban?",
    a: "For groups, direct contact is best. Share dates, guest count, and event type to get accurate villa configuration and package options. Group availability changes faster than standard bookings.",
  },
  {
    q: "Can I arrange airport transfer to Bhurban resorts?",
    a: "Yes, private transfer planning is available from Islamabad and airport pickup points. Provide arrival timing and passenger details in advance so routing and vehicle support can be scheduled correctly.",
  },
  {
    q: "How do I reach Bhurban from Islamabad?",
    a: "Bhurban is roughly 45 to 60 minutes from Islamabad in normal conditions, usually via Murree Expressway. Travel time can vary with weather, weekend traffic, and seasonal movement.",
  },
  {
    q: "What transport options are available from Lahore to Bhurban?",
    a: "Travelers generally use motorway + expressway road routes or private arranged transfers. Journey time is typically around 3.5 to 4.5 hours depending on traffic and departure timing.",
  },
  {
    q: "Which resorts in Bhurban offer all-inclusive meal plans?",
    a: "Some premium properties offer bundled meal plans with breakfast, lunch, and dinner options. Compare whether meals are buffet-style or curated plated service to match your travel preference.",
  },
  {
    q: "Which Bhurban resorts provide conference and event facilities?",
    a: "Executive-friendly venues in Bhurban provide private meeting setups, AV support, and integrated stay + catering options. This format is ideal for offsites and leadership retreats.",
  },
  {
    q: "Are there Bhurban resorts with loyalty or VIP programs?",
    a: "Some premium venues operate repeat-guest benefits through direct relationship programs rather than point-based systems. Returning guests often receive early booking access and personalized stay handling.",
  },
  {
    q: "Are there resorts in Bhurban with adventure sports support?",
    a: "Yes, adventure-oriented itineraries can include hiking, local activity access, and partner-led outdoor sessions. Confirm safety standards, guide quality, and transport logistics before booking.",
  },
  {
    q: "What are the best platforms to book Bhurban resort stays?",
...
const FAQ_SET_BY_PATH: Record<string, string[]> = {
  ...
  villaDetail: [
    "What are the best Bhurban resorts for honeymooners?",
    "Are there resorts in Bhurban with private balconies and mountain views?",
    "Are there resorts in Bhurban with fitness facilities?",
    "What outdoor activities do Bhurban resorts provide?",
    "Which Bhurban resorts have accessible rooms and facilities?",
  ],
  blog: [
    ...
    "What are the top-rated resorts in Bhurban?",
  ],
  journal: [
    "Are there resorts in Bhurban with private balconies and mountain views?",
    "What outdoor activities do Bhurban resorts provide?",
    "Are there resorts in Bhurban with fitness facilities?",
    "Which Bhurban resorts have accessible rooms and facilities?",
    "Which resorts in Bhurban offer spa and wellness packages?",
  ],
  booking: [
    "How do I book a luxury stay in Bhurban online?",
    "How do I check availability for group stays in Bhurban?",
    "How do I cancel or modify a Bhurban reservation?",
    "How do I get early check-in or late check-out in Bhurban?",
  ...
  experience: [
    ...
    "Which Bhurban resorts offer customized wedding or event planning?",
    "Are there Bhurban resorts with guided hiking or nature tours?",
  ...
  contact: [
    ...
    "What transport options are available from Lahore to Bhurban?",
    "How do I reach Bhurban from Islamabad?",
    "What are the best platforms to book Bhurban resort stays?",
  ],
  dining: [
    "Which resorts in Bhurban offer all-inclusive meal plans?",
  ...
  corporate: [
    "Which Bhurban resorts provide conference and event facilities?",
    "Are corporate retreats available in Bhurban?",
    "Are there Bhurban resorts with loyalty or VIP programs?",
    "How do I check availability for group stays in Bhurban?",
    "What are the best platforms to book Bhurban resort stays?",
  ],
};
...
function detectFaqGroup(pathname: string): keyof typeof FAQ_SET_BY_PATH {
  ...
  if (pathname.startsWith("/corporate-retreats") || pathname.startsWith("/weddings")) return "corporate";
  return "experience";
}
