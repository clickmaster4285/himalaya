            ...
            <section className="relative min-h-[720px] overflow-hidden">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 pt-32 sm:pt-36 pb-16 sm:pb-20 md:pt-44">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 sm:mt-5 max-w-2xl text-white/90 text-sm sm:text-base md:text-lg leading-relaxed">Host your reserve our sufi qawwali venue with us. Host your private mehfil, corporate event, or cultural gathering in our dedicated Sufi space. We provide the authentic ambiance, professional sound, and renowned qawwali artists for an unforgettable evening.</p>
