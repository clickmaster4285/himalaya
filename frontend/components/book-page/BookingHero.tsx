...
const BOOK_WHATSAPP = buildWhatsAppBookingUrl("hotel in bhurban murree");
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div className="max-w-xl text-left">
          ...
          <div className="mt-12 flex flex-wrap gap-3">
            ...
            >
              <span>▶</span> Book villas in bhurban murree
            </Link>
            <a
              href={BOOK_WHATSAPP}
              target="_blank"
            ...
            >
              Bhurban hotel murree — WhatsApp
            </a>
            <Link
              href="/hotels-in-bhurban"
              className="border border-[#c9a55b]/40 text-[#c9a55b] px-8 py-3.5 text-[11px] font-bold uppercase tracking-widest hover:border-[#c9a55b] transition-colors"
            >
              Compare bhurban hotels
            </Link>
          </div>
        </div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              ...
              >
                ...
                Best hotel in bhurban — WhatsApp rates
              </a>
