    ...
    <div className="min-h-screen bg-white">
      <section className="relative min-h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 pt-36 pb-20 md:pt-44">
          ...
          <p className="mt-5 max-w-2xl text-white/90 text-sm md:text-base leading-relaxed">
            Hero section slider har 3 second me image change karta hai. Mehndi events ke liye same premium flow ready hai.
          </p>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="font-display text-3xl md:text-4xl text-neutral-900">Why Mehndi at Himalaya Villas</h2>
